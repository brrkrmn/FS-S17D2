...
public class DeveloperController {
    ...
    public void create(@RequestBody Developer developer) {
        final Developer newDev = switch (developer.getExperience()) {
            case JUNIOR -> new JuniorDeveloper(developer.getId(), developer.getName(), developer.getSalary()- developerTax.getSimpleTaxRate());
            case MID -> new MidDeveloper(developer.getId(), developer.getName(), developer.getSalary()- developerTax.getMiddleTaxRate());
            case SENIOR -> new SeniorDeveloper(developer.getId(), developer.getName(), developer.getSalary()-developerTax.getUpperTaxRate());
        };
